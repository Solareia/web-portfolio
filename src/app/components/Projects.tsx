        ...
        <main>
            <div className="block md:w-full h-screen bg-[#d6d8df] bg-crustlight" id="projects">
                ...
                <div className="block md:flex md:justify-center place-items-center h-3/4">
                    <Link href={"#"} className="md:w-2/12 flex items-center justify-center text-center h-2/5 shadow-md transition-shadow duration-500 hover:shadow-xl rounded-md mx-10 my-2 md:p-4 md:h-3/4 bg-[#e6e7ed] text-[#40434f]">
                        <div className="block">
