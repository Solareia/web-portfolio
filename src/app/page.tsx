        ...
        <main className="h-dvh">
            ...
            <div className="flex justify-center items-center h-full">
                <div className="block">
                    ...
                    <p className="text-6xl flex justify-center my-4 bg-gradient-to-r from-yellow-300 via-blue-400 to-green-400 bg-clip-text text-transparent">AriaLeFey</p>
                    <p className="flex justify-center items-center text-center w-full font-thin text-[#565f89] mb-4 md:text-lg text-sm">I focus on embedded systems, networking, and security.</p>
